...
- financial forecasting (RNN-based GANs) • satellite image classification [(cnn)](https://github.com/phrugsa-limbunlom/densenet201-classifier) • spacecraft landing [(mlp)](https://github.com/phrugsa-limbunlom/multi-regressor-mlp) • biochemical production [(rf,xgboost,svm)](https://github.com/phrugsa-limbunlom/mimo-regressor)
